...
if __name__ == "__main__":
            ...
            if data_with_leak:
                if small_leak:
                    ...
                    if small_demand_variance_data:
                        data_path = 'data/training_data_with_leak_small_demand_variance/network_' + str(case)
                    else:
                        data_path = 'data/training_data_with_leak/network_' + str(case)
            else:
                if small_demand_variance_data:
                    data_path = 'data/training_data_no_leak_small_demand_variance/network_' + str(case)
                else:
    ...
    if train_data:
        if data_with_leak:
            df.to_pickle("training_classification_data_with_leak.pkl")
        else:
            df.to_pickle("training_classification_data_no_leak.pkl")
    else:
        if data_with_leak:
            df.to_pickle("test_classification_data_with_leak.pkl")
        else:
            df.to_pickle("test_classification_data_no_leak.pkl")
